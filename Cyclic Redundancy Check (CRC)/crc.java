...
class crc {
	public static void main(String args[]) {
		...
		// this will have the remainder generated by the above method appended to the inputted data
	...
	static int[] divide(int old_data[], int divisor[]) {
		...
		// initially the array remainder is filled with 0 using arraycopy
		System.arraycopy(data, 0, remainder, 0, divisor.length);
		
		// This loop will continuously exor the bits of the remainder and divisor
	...
	// helper method to exor the bits
	...
	static void receive(int data[], int divisor[]) {
		// it accepts the data and divisor (although the receiver already has the divisor value stored with no need for the sender to resend it) 
		int remainder[] = divide(data, divisor);
